...
int main(int argc, char* argv[])
{
    ...
    {
        std::cout << "Create a counter and use default value (0)." <<std::endl;
        size_t my_counter_a {};
        std::cout << "my_counter: " << my_counter_a << "\n" << std::endl;

        std::cout << "Create a counter and give a value (1)." <<std::endl;
        size_t my_counter_b {1};
        std::cout << "my_counter: " << my_counter_b << "\n" << std::endl;
    }
